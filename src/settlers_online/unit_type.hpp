...
namespace ropufu::settlers_online
{
    ...
    void from_json(const nlohmann::json& j, unit_type& x) noexcept
    {
        ...
        aftermath::flags_t<battle_phase> attack_phases = x.attack_phases(); // required
        aftermath::flags_t<special_ability> abilities = x.abilities(); // optional
        aftermath::flags_t<battle_trait> traits = x.traits(); // optional
