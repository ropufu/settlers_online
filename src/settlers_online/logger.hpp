...
namespace ropufu::settlers_online
{
    namespace detail
    {
        ...
        public:
            constexpr void touch() const noexcept { }
            ...
            std::size_t tag() const noexcept { return this->m_tag; }
            void set_tag(std::size_t value) noexcept { this->m_tag = value; }
        ...
        struct no_logger
        {
            ...
            std::size_t tag() const noexcept { return 0; }
            void set_tag(std::size_t) const noexcept { }
